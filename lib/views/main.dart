//import 'package:flutter_application_1/Screen/validattion_form.dart';
        ...
        children: <Widget>[
          Card(
            ...
            child: Padding(
              ...
              child: Text(
                "Tạo Tài Khoản",
                style: TextStyle(color: Color.fromRGBO(255,210,51,1), fontSize: 32, height: 2),
              ),
            ),
          ),
          Text(
          ...
          SizedBox(
            ...
            child: OutlinedButton(
                onPressed: () {
                  Navigator.push(_LogInState.currentContext, MaterialPageRoute(builder: (context){
                    return FormValidation();
                  }));
                },
                child: const Text('Khiếm thị', style: TextStyle(color: Colors.black,fontSize: 20),),
            ),
          ),
          SizedBox(
            width: 300.0, // <-- match_parent
            ...
            child: OutlinedButton(
                ...
                }, child: const Text('Khiếm thính', style: TextStyle(color: Colors.black,fontSize: 20))),
          ),
          SizedBox(
            width: 300.0, // <-- match_parent
            height: 50, // <
            child: OutlinedButton(
                ...
                child: const Text('Rối loạn tăng động, giảm chú ý', style: TextStyle(color: Colors.black,fontSize: 20))),
          ),
          SizedBox(
            width: 300.0, // <-- match_parent
            height: 50, // <
            child: OutlinedButton(
                ...
                child: const Text('Chứng khó đọc (đang phát triển', style: TextStyle(color: Colors.black,fontSize: 20))),
          ),
          SizedBox(
            width: 300.0, // <-- match_parent
            height: 50, //
            child: OutlinedButton(
                ...
                }, child: const Text('Không có khiếm khuyết', style: TextStyle(color: Colors.black,fontSize: 20))),
          ),
